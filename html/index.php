...
<html lang="en">
  <head>
    ...
    <title>OpenMarket Template</title>
    ...
    <nav class="navbar navbar-dark navbar-fixed-top bg-inverse">
      ...
      <div id="navbar">
        <nav class="nav navbar-nav float-xs-left">
          <a class="nav-item nav-link" href="#">Vendor Reviews</a>
          <a class="nav-item nav-link" href="#">Lab Results</a>
          <a class="nav-item nav-link" href="#">Listings</a>
          <a class="nav-item nav-link" href="#">Harm Reduction</a>
          <a class="nav-item nav-link" href="#">Community Forum</a>
